/**
 * @module Ink.Data.Tabs
 * @desc Tabs bindings (Wrapper for Ink Tabs component (with fix to handle SPA's with hash routing)
 * @author hlima, ecunha, ttt  AT sapo.pt
 * @version 1
 */

Ink.createModule('Ink.Data.Tabs', '1', ['Ink.Data.Binding_1', 'Ink.UI.Common_1','Ink.Dom.Event_1','Ink.Dom.Css_1','Ink.Dom.Element_1','Ink.Dom.Selector_1'], function(ko, Common, Event, Css, Element, Selector) {
    /**
    ...
    Tabs.prototype = {
        ...
        _setFirstActive: function() {
            ...
            // PINK: Fixed lookup order
            var activeMenuLink = (!this._options.preventUrlChange && this._findLinkByHref(hash)) ||
    ...
    ko.bindingHandlers.tabs = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel) {
            ...
            var options = {preventUrlChange: true}; // sensible defaults 
